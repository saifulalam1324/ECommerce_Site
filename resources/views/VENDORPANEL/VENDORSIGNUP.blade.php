        ...
        <div class="row">
            <div class="container d-flex justify-content-center align-items-center" style="min-block-size:100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                    ...
                    @endif
                    <form action="{{ route('VendorSignup') }}" method="POST" class="mb-3">
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="name" id="name" name="company_name" />
                    ...
                    <div class="text-center">
                        <p>or..</p>
                        <a href="{{ route('VendorLoginPage') }}" id="showLogin">Login</a>
                    </div>
                </div>
            </div>
        </div>
