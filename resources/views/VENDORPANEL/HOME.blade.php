                    ...
                    <div class="container-fluid mt-2">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <span class="text-white" style="font-size: 14px">Washing Machine: {{$Washingmachine}}</span><br>
                            ...
                            <div class="col-6">
                                <span class="text-white" style="font-size: 14px">Electric Stove: {{$Electricstove}}</span><br>
                                ...
                                <span class="text-white" style="font-size: 14px">Vacuum Cleaner: {{$Vacuumcleaner}}</span><br>
        ...
        <div class="container mt-3 ml-2 pt-5 mb-5 justify-content-center d-flex">
            <div class="row container">
                <div class="col-4 justify-content-center d-flex"
                    style="background-color: #081621; border-radius: 10px;">
                    <div class="container-fluid mt-2">
                        <h6 class="text-white text-center mt-2">Totale Quantity Of Sale: {{$sumc}}</h6>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <span class="text-white" style="font-size: 14px">Washing Machine: {{$Washingmachinec}}</span><br>
                            ...
                            <div class="col-6">
                                <span class="text-white" style="font-size: 14px">Electric Stove: {{$Electricstovec}}</span><br>
                                ...
                                <span class="text-white" style="font-size: 14px">Vacuum Cleaner: {{$Vacuumcleanerc}}</span><br>
